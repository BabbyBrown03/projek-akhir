...
<head>
  ...
  <style>
    ...
    .hero {
      background: url('img/bawang-putih.jpg') center/cover no-repeat;
      padding: 100px 20px;
      text-align: center;
    }
    ...
    .container { padding: 40px 20px; background: #fff9f0; }
...
<header>
  <div class="hero">
    ...
    <a href="#resep-terbaru">Lihat Resepnya</a>
  </div>
</header>

<section class="container" id="resep-terbaru">
